	...
	reload: function() {
		...
		if ( hp.photoblog.current_user.album_view && prevnext[3] ) {
			can_next = false;
						...
						throw new Exception('Error loading last thumb image..');
