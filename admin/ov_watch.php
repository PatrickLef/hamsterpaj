<?php
	...
	$action_types = array(
										...
										'report event'	=> array('name' => 'Skickade rapporter', 'privilegie' => 'abuse_report_handler'),
	...
	{
		$action = $action_types['post removed'];
	}
	...
	$out .= '<p>Här visas statistik baserat på ' . $action['name'] . ' under ' . (isset($days) ? $days : 'alla') . ' dagar</p>' . "\n";
