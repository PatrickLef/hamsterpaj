<?php
  ...
  echo '<p>' . "\n";
  echo 'Inom kort kommer komma ett verktyg som du kan använda för att fixa kod till Hamsterpaj. Sålänge finner du koden på <a href="http://github.com/Hamsterpaj/hamsterpaj/">Github</a>. Att lägga upp kod är än så länge inte möjligt.' . "\n";
  echo '</p>' . "\n";
  ...
  echo '<br />' . "\n";
	...
	echo 'Kontakta en sysop på siten så fixar de en adress till dig där du kan tanka ner databasstruktur. OBS! Då MÅSTE få allt annat att funka (sajten i övrigt med kod och egenhostad server mm.) INNAN du frågar om detta.';
	echo '</p>' . "\n";
