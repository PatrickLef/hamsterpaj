<?php
	...
	default:	    
	    $content .= '<h1 id="photoblog_upload_simple">En enklare uppladdning!</h1>';
		...
		$options['message'] .= sprintf('<a href="/fotoblogg/%s#image-%d">klicka på den här länken och komma direkt till din rykande färska bild.</a>', $_SESSION['login']['username'], $_SESSION['photoblog_upload_id']);
		...
		<div>
			...
			<h3>Bild</h3>
			<p><label><strong>Fil: </strong> <input type="file" name="image" /></label> <label>Album: <select class="photoblog_upload_album" name="album">' . $options . '</select></label></p>
